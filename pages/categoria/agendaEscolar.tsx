...
const AgendaEscolarPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Agenda escolar')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Agenda escolar' pageDescription='Página agenda escolar de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - AGENDA ESCOLAR</Typography>
...
export default AgendaEscolarPage;
