...
const LibretasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Libretas')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Libretas' pageDescription='Página libretas de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - LIBRETAS</Typography>
