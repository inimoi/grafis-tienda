...
const FundasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Fundas')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Fundas' pageDescription='Página fundas de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - FUNDAS</Typography>
