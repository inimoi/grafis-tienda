...
const BoligrafosPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Boligrafos')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Bolígrafos' pageDescription='Página bolígrafos de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - BOLIGRAFOS</Typography>
