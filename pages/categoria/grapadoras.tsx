...
const GrapadorasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Grapadoras')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Grapadoras' pageDescription='Página grapadoras de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - GRAPADORAS</Typography>
