...
const CalculadorasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Calculadoras')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Calculadoras' pageDescription='Página calculadoras de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - CALCULADORAS</Typography>
