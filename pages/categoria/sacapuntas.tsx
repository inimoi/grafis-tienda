...
const SacapuntasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Sacapuntas')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Sacapuntas' pageDescription='Página sacapuntas de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - SACAPUNTAS</Typography>
