...
const CintaDymoPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Cinta dymo')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Cinta Dymo' pageDescription='Página Cinta Dymo de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - CINTA DYMO</Typography>
