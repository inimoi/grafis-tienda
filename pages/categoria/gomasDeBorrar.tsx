...
const GomasDeBorrarPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Gomas de borrar')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Gomas de borrar' pageDescription='Página gomas de borrar de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - GOMAS DE BORRAR</Typography>
...
export default GomasDeBorrarPage;
