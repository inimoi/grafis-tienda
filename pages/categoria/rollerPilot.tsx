...
const RollerPilotPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Roller pilot')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Roller pilot' pageDescription='Página Roller pilot de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - ROLLER PILOT</Typography>
...
export default RollerPilotPage;
