...
const PlastilinaPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Plastilina')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Plastilina' pageDescription='Página plastilina de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - PLASTILINA</Typography>
