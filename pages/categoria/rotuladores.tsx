...
const RotuladoresPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Rotuladores')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Rotuladores' pageDescription='Página rotuladores de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - ROTULADORES</Typography>
...
export default RotuladoresPage;
