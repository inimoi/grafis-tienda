...
const CompasesPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Compases')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Compases' pageDescription='Página compases de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - COMPASES</Typography>
