...
const CerasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Ceras')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Ceras' pageDescription='Página ceras de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - CERAS</Typography>
