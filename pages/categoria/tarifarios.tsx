...
const TarifariosPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Tarifarios')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Tarifarios' pageDescription='Página tarifarios de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - TARIFARIOS</Typography>
