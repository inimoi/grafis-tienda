...
const PortaPlanosPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Porta planos')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Porta planos' pageDescription='Página porta planos de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - PORTA PLANOS</Typography>
...
export default PortaPlanosPage;
