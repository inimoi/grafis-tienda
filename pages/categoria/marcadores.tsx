...
const MarcadoresPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Marcadores')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Marcadores' pageDescription='Página marcadores de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - MARCADORES</Typography>
