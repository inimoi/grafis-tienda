...
const PendrivePage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Pendrive')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Pendrive' pageDescription='Página pendrive de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - PENDRIVE</Typography>
