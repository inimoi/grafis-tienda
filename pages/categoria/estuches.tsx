...
const EstuchesPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Estuches')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Estuches' pageDescription='Página estuches de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - ESTUCHES</Typography>
