...
const ForroLibrosPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Forro libros')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Forro libros' pageDescription='Página forro libros de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - FORRO LIBROS</Typography>
...
export default ForroLibrosPage;
