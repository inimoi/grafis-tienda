...
const CorrectoresPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Correctores')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Correctores' pageDescription='Página correctores de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - CORRECTORES</Typography>
...
export default CorrectoresPage;
