...
const LapicesPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Lapices')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Lapices' pageDescription='Página lapices de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - LAPICES</Typography>
