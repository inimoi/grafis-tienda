...
const ReglasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Reglas')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Reglas' pageDescription='Página reglas de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - REGLAS</Typography>
