...
const TijerasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Tijeras')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Tijeras' pageDescription='Página tijeras de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - TIJERAS</Typography>
