...
const PegamentosPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Pegamentos')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Pegamentos' pageDescription='Página pegamentos de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - PEGAMENTOS</Typography>
