...
const CarpetasPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Carpetas')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Carpetas' pageDescription='Página carpetas de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - CARPETAS</Typography>
