...
const EddingPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Edding')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Edding' pageDescription='Página edding de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - EDDING</Typography>
