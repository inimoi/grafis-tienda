...
const ResmilleriaPage: NextPage = () => {

  const { products, isLoading } = useProducts('/products?categoria=Resmilleria')                 //el custom hook de SWR que hemos creado para traer los productos

  return (
    <ShopLayout title='Papelería - Resmilleria' pageDescription='Página resmilleria de la papelería'>
      <Box marginTop='100px'>
        <Typography variant='h1' component='h1'>TIENDA PAPELERIA - RESMILLERIA</Typography>
...
export default ResmilleriaPage;
